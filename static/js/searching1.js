function searching1(){
    ...
    var mainJson = JSON.stringify(main);
    ...
    $.ajax({
        ...
        success: function(data) {
          ...
          var max = Math.ceil(data['serach_num']/5);
...
function updatePagination(currentPage,totalPages){
  ...
  for(var i=1 ; i<=totalPages*10;i++)
  {
      $('#content_'+i).css('display', 'none');
      $('#content_'+i).removeClass("d-flex");
  }
  var max_display =currentPage*5 ;
  var display =max_display-4;
